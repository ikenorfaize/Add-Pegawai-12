...
<head>
    ...
    <style>
        ...
        /* Add margin to separate the two sections */
        .section-header {
            margin-top: 40px; /* Adjust this value for more or less space */
        }
    </style>
</head>
...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php
            $sql = "SELECT calon_siswa.*, pegawai.nama AS pegawai_nama 
                    FROM calon_siswa
            ...
            while ($siswa = mysqli_fetch_array($query)) {
                ...
                echo "<td>".$siswa['pegawai_nama']."</td>"; // Displaying the pegawai name
                echo "<td>";
    ...
    <table>
        ...
        <tbody>
            ...
            $query_pegawai = mysqli_query($db, $sql_pegawai);
